package com.celestialapps.leowallet.monitor;
...
public class ControllerMonitor {
    ...
    @Before("execution(* com.celestialapps.leowallet.controller.*Controller.*(..))")
    public void logBeforeMethodCall(JoinPoint joinPoint) {
        startTime = System.currentTimeMillis();
    }

    @AfterReturning("execution(* com.celestialapps.leowallet.controller.*Controller.*(..))")
    ...
    @AfterThrowing("execution(* com.celestialapps.leowallet.controller.*Controller.*(..))")
